<template>
  <div class="wallet">
    <svg
      ...
      style="enable-background:new 0 0 890.5 890.5;"
      xml:space="preserve"
      class="icon"
    >
      <path
      ...
      />
      <path
        d="M673.3,86.46c-4.399,0-8.8,0.6-13.2,1.8l-83.399,22.8L322,180.56h289.1h126l-15.6-57.2
    ...
    <div class="info">
      ...
      <span class="currency currency--kick">KICK</span>
      <span class="value">
        {{
          getCurrentEth
            .toLocaleString('ru', {
      ...
      <span class="currency currency--eth">ETH</span>
    </div>
  </div>
</template>
...
export default {
  computed: {
    ...mapGetters('dealForm', ['getCurrentEth', 'getCurrentKick']),
  },
}
</script>
